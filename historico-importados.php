<?php
  ...
  $pathPage = '
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
      ...
      <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Importar CSV</li>
    </ol>
    <h6 class="font-weight-bolder mb-0">Históricos de Importação</h6>
  ';
  ...
  $sql = "SELECT chave, chave_produto, qtd_seriais, seriais_distribuidos, cadastro FROM lote_importacao ORDER BY chave DESC";
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid">
      <a class="btn bg-gradient-secondary" href="importar-csv.php"><i class="fas fa-arrow-circle-left me-2"></i>Voltar</a>
    </div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Tabelas Importadas Anteriormente</h6>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Distribuidas</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Produto</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Data Importação</th>
                  ...
                  <tbody>
                    <?php while($dados = $qry->fetch_assoc()){
                      ...
                      $produtoId = $dados['chave_produto'];

                      $sqlP = "SELECT p.nome, (SELECT c.nome FROM categorias c WHERE c.chave = p.chave_categoria) as categoria FROM produtos p WHERE p.chave = '$produtoId'";
                    ...
                    <tr>
                      ...
                      <td>
                        <h6 class="ps-3 mb-0 text-sm"><?php echo $dados['seriais_distribuidos']; ?></h6>
                      </td>
                      <td>
                        <h6 class="ps-3 mb-0 text-sm"><?php echo $dadosP['nome']. ' ' .$dadosP['categoria']; ?></h6>
                      </td>
                      <td>
                      ...
                      <td>
                        <h6 class="ps-3 mb-0 text-sm">
                          <?php if($dados['seriais_distribuidos'] <= 0){ ?>
                          <a style="cursor: pointer;" onclick="excluir(this.id)" id="<?php echo $dados['chave']; ?>"><i class="fas fa-trash"></i></a>
                          <?php }else{} ?>
                        </h6>
                      </td>
                    </tr>
  ...
  <?php if(isset($_GET['success']) && isset($_GET['exImp'])){ ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Importação de Lista excluida com sucesso.
          </div>
  ...
  <script type="text/javascript">
    ...
    function excluir(loteID) {
      
      window.location.href = "sys/update.php?excluirImportacao&i="+loteID;

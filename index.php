<?php
  ...
  $sql = "SELECT chave FROM seriais WHERE chave_estoque = '$chaveEstoque' AND status = '0'";
  $qry = $strcon->query($sql) or die($strcon->error);
  $seriaisDisponiveis = mysqli_num_rows($qry);

  if($_SESSION['nivelRevenda'] == '777'){

    $sql = "SELECT chave FROM seriais WHERE chave_estoque != '$chaveEstoque'";
    $qry = $strcon->query($sql) or die($strcon->error);
    $seriaisCarga = mysqli_num_rows($qry);

    $sql = "SELECT chave FROM seriais WHERE chave_estoque != '$chaveEstoque' AND status = '0'";
    $qry = $strcon->query($sql) or die($strcon->error);
    $cargaDisponivel = mysqli_num_rows($qry);

    $sql = "SELECT chave FROM seriais WHERE chave_estoque != '$chaveEstoque' AND status = '1'";
    $qry = $strcon->query($sql) or die($strcon->error);
    $cargaUsada = mysqli_num_rows($qry);
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Seriais Disponíveis</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo $seriaisDisponiveis ?>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Seriais em Carga</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo $seriaisCarga ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Carga não Usados</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo $cargaDisponivel ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Carga Usados</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo $cargaUsada ?>
                    </h5>
                  </div>

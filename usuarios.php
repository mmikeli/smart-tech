<?php
  ...
  $pathPage = '
    ...
    <h6 class="font-weight-bolder mb-0">Usuários</h6>
  ';
  ...
  $sql = "SELECT chave, email, senha, nome, status FROM usuarios WHERE chave_revenda = '1'";
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid">
      <?php if($_GET['SoEuNaCausa']){ ?><a class="btn bg-gradient-primary" href="cad.php?usuario">Cadastrar Novo</a><?php } ?>
      <a class="btn bg-gradient-secondary" href="#" title="DESATIVADO">Cadastrar Novo</a>
    </div>
                  ...
                  <tbody>
                    ...
                    <tr ondblclick="edit(this.id)" id="<?php echo $dados['chave']; ?>">
                      ...
                      <td>
                        ...
                        <span class="ms-3 badge badge-sm bg-gradient-danger">Offline</span>
                        <?php }else{ ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.location.href = 'usuarios.php'">Fechar</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Algo deu errado, usuário não cadastrado. Tente novamente!
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.location.href = 'cad.php?usuario'">Fechar</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Algo deu errado, usuário não editado. Tente novamente!
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.location.href = 'cad.php?usuario'">Fechar</button>
          </div>
  ...
  <script type="text/javascript">
    ...
    function edit(usuID){
      ...
      window.location.href = "edit.php?usuario&i="+usuID;

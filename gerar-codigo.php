<?php
  ...
  $pathPage = '
    ...
    <h6 class="font-weight-bolder mb-0">Gerar Código</h6>
  ';
  ...
  $sqlP = "SELECT p.chave, p.nome, (SELECT c.nome FROM categorias c WHERE c.chave = p.chave_categoria) as categoria FROM produtos p";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Gerar um Novo Código</h6>
            </div>
            <div class="card-body">
              <form class="row" role="form" method="POST" action="sys/update.php?gerar">
                    ...
                    <select name="produto" class="form-control select2" required>
                      <option selected disabled>:: SELECIONE ::</option>
                        <?php while($dadosP = $qryP->fetch_assoc()){
                          ...
                          $sqlQS = "SELECT chave FROM seriais WHERE chave_produto = '$chaveDesteProduto' AND status = '0' AND chave_estoque = '$chaveEstoque'";
                ...
                <div class="text-center">
                  <button id="btnGerar" type="submit" class="btn bg-gradient-primary w-100 mt-4 mb-0">Salvar</button>
                </div>

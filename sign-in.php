            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Insira seu usuário e senha para entrar</p>
                </div>
                <?php if(isset($_GET['incorrect'])){ ?>
                <div class="card-header pb-0 text-left bg-transparent">
                  <h6 class="font-weight-bolder text-danger text-gradient">Usuário ou senha incorretos</h6>
                </div>
                <?php } ?>
                <div class="card-body">
                  <form role="form" class="row" method="POST" action="sys/login.php">
                    ...
                    <div class="col-1 row align-items-center justify-content-center">
                      <i style="padding-top: 20px;" id="eyeOpen" class="fas fa-eye"></i>
                      <i style="padding-top: 20px;" id="eyeClose" class="fas fa-eye-slash"></i>
                    </div>

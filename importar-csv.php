<?php
  ...
  $pathPage = '
    ...
    <h6 class="font-weight-bolder mb-0">Importar CSV</h6>
  ';
  ...
  $sql = "SELECT p.chave, p.nome, (SELECT c.nome FROM categorias c WHERE c.chave = p.chave_categoria) as categoria FROM produtos p";
  $qry = $strcon->query($sql) or die($strcon->error);
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid">
      ...
      <a class="btn bg-gradient-info" href="historico-importados.php">Histórico</a>
    </div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Importar Tabela de Seriais</h6>
            </div>
            <div class="card-body">
              <form enctype="multipart/form-data" class="row" role="form" method="POST" action="sys/create.php?teste_imports">
                ...
                <div class="col-5">
                  ...
                  <select name="produto" class="form-control select2" required>
                    ...
                    <option value="<?php echo $dados['chave'] ?>"><?php echo $dados['nome']. ' ' .$dados['categoria']; ?></option>
                    <?php } ?>
                  </select>
                </div>

                <div class="col-7">
                  <label>Clique em *Escolher Arquivo* para subir uma nova planilha</label>
